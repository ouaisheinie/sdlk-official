...
const HeaderMobile: React.FC<HeaderMobileProps> = props => {
    ...
    return (
        <div className={styles.header_container} style={{ 
            ...
            <picture>
                <img src="https://cdnimg.vivaia.com/VA/image/Banner/20230331_5378/starlinke-whitebg.png" alt="STARLINKE" style={{ display: 'inline-block', width: 150, height: 36, marginLeft: 20 }}/>
            </picture>
            {
                folding 
